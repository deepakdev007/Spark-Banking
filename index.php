...
<html lang="en">
  ...
  ?>
      ...
      <div class="container-fluid">
            ...
            <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img class="im" src="img/banks.jpg" class="img-fluid pt-2">
              </div>
            </div>
          ...
          <br>
          <br>
          <h3 class="action" ><span style="font-family: 'Roboto Slab', serif">View + Transfer</h3></span>
      ...
      <footer class="text-center mt-5 py-2">
        <p>A Project by <b>Deepak Dev</b> <br> </p>
      </footer>
